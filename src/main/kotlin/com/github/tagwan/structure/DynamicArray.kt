 ...
 * dynamic array
 *
 * describe: Wrapper above normal array, Check index
 * When the array overflows, its size will increase dynamically
 */
...
class DynamicArray(private var capacity: Int = 10) {
    ...
    /**
     * Removes an element from the array and moves subsequent elements to their positions
     *
     * @value - элемент
     */
