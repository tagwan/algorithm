...
package com.github.tagwan.puremvc.patterns.facade

import com.github.tagwan.puremvc.core.Controller
import com.github.tagwan.puremvc.core.Model
import com.github.tagwan.puremvc.core.View
import com.github.tagwan.puremvc.interfaces.*
import com.github.tagwan.puremvc.patterns.observer.Notification
import java.util.concurrent.ConcurrentHashMap

/**
 * A base Multiton <code>IFacade</code> implementation.
 *
 * @see com.github.tagwan.puremvc.core.Model Model
...
open class Facade(key: String) : IFacade {
    ...
    protected open fun initializeController() {
        controller = com.github.tagwan.puremvc.core.Controller.getInstance(multitonKey) { key ->
            com.github.tagwan.puremvc.core.Controller(
                key
            )
        }
    }
