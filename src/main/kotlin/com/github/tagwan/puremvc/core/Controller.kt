...
import com.github.tagwan.puremvc.interfaces.IController
import com.github.tagwan.puremvc.interfaces.INotification
import com.github.tagwan.puremvc.interfaces.IView
import com.github.tagwan.puremvc.patterns.observer.Observer
 ...
 *
 * @see View View
 * @see com.github.tagwan.puremvc.patterns.observer.Observer Observer
 * @see com.github.tagwan.puremvc.patterns.observer.Notification Notification
 * @see com.github.tagwan.puremvc.patterns.command.SimpleCommand SimpleCommand
 * @see com.github.tagwan.puremvc.patterns.command.MacroCommand MacroCommand
 *
...
open class Controller(key: String) : IController {
    ...
    companion object {
         ...
         */
        @Synchronized
        fun getInstance(key: String, factory: (key: String) -> IController): IController {
     ...
     */
    override fun initializeController() {
        view = View.getInstance(multitonKey) { key ->
            View(key)
        }
    }
    ...
    override fun executeCommand(notification: INotification) {
        this.commandMap[notification.name]?.let { factory ->
