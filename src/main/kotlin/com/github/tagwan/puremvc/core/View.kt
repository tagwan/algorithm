...
import com.github.tagwan.puremvc.interfaces.IMediator
...
open class View(key: String) : IView {
    ...
    companion object {
         ...
         */
        @Synchronized
        fun getInstance(key: String, factory: (key: String) -> IView): IView {
    ...
    override fun registerObserver(notificationName: String, observer: IObserver) {
        observerMap.getOrPut(notificationName) { mutableListOf() }.add(observer)
    }
