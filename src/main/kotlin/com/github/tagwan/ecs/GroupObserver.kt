...
import com.github.tagwan.ecs.event.impl.GroupChangedArgs
import com.github.tagwan.ecs.exception.GroupObserverException
import java.util.*
/**
 * Collector提供了便捷的方法来对group的变化作出反应。
 * 比如你想汇总和处理所有添加或替换PositionComponent的实体entities。
