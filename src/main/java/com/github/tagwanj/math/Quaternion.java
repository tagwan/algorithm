...
public class Quaternion implements Serializable {
     ...
     */
    public Quaternion(com.github.tagwanj.math.Vector3 axis, float angle) {
        this.set(axis, angle);
    }
     ...
     * @return This quaternion for chaining.
     */
    public Quaternion set(com.github.tagwanj.math.Vector3 axis, float angle) {
     ...
     *            Vector to transform
     */
    public com.github.tagwanj.math.Vector3 transform(com.github.tagwanj.math.Vector3 v) {
        tmp2.set(this);
        tmp2.conjugate();
     ...
     * @return This quaternion for chaining.
     */
    public Quaternion setFromAxis(final com.github.tagwanj.math.Vector3 axis, final float degrees) {
     ...
     * @return This quaternion for chaining.
     */
    public Quaternion setFromAxisRad(final com.github.tagwanj.math.Vector3 axis, final float radians) {
    ...
    public Quaternion setFromAxisRad(final float x, final float y, final float z, final float radians) {
        float d = com.github.tagwanj.math.Vector3.len(x, y, z);
        if (d == 0f)
            return idt();
        d = 1f / d;
    ...
    public Quaternion setFromAxes(boolean normalizeAxes, float xx, float xy, float xz, float yx, float yy, float yz,
        ...
        if (normalizeAxes) {
            final float lx = 1f / com.github.tagwanj.math.Vector3.len(xx, xy, xz);
            final float ly = 1f / com.github.tagwanj.math.Vector3.len(yx, yy, yz);
            final float lz = 1f / com.github.tagwanj.math.Vector3.len(zx, zy, zz);
            xx *= lx;
            xy *= lx;
            xz *= lx;
            yx *= ly;
     ...
     * @return This quaternion for chaining
     */
    public Quaternion setFromCross(final com.github.tagwanj.math.Vector3 v1, final com.github.tagwanj.math.Vector3 v2) {
    ...
    public Quaternion setFromCross(final float x1, final float y1, final float z1, final float x2, final float y2,
                                   final float z2) {
        final float dot = MathUtil.clamp(com.github.tagwanj.math.Vector3.dot(x1, y1, z1, x2, y2, z2), -1f, 1f);
        final float angle = (float) Math.acos(dot);
     ...
     */
    public float getAxisAngle(com.github.tagwanj.math.Vector3 axis) {
     ...
     *      "http://www.euclideanspace.com/maths/geometry/rotations/conversions/quaternionToAngle">calculation</a>
     */
    public float getAxisAngleRad(com.github.tagwanj.math.Vector3 axis) {
        if (this.w > 1)
     ...
     * normalize the quaternion. Use {@link #getAxisAngleRad(com.github.tagwanj.math.Vector3)} to get both
     * the axis and the angle of this rotation. Use
     * {@link #getAngleAroundRad(com.github.tagwanj.math.Vector3)} to get the angle around a specific axis.
     *
     ...
     * {@link #getAxisAngle(com.github.tagwanj.math.Vector3)} to get both the axis and the angle of this
     * rotation. Use {@link #getAngleAround(com.github.tagwanj.math.Vector3)} to get the angle around a
     * specific axis.
     *
    ...
    public void getSwingTwist(final float axisX, final float axisY, final float axisZ, final Quaternion swing,
        ...
        final float d = com.github.tagwanj.math.Vector3.dot(this.x, this.y, this.z, axisX, axisY, axisZ);
     ...
     *      "http://www.euclideanspace.com/maths/geometry/rotations/for/decomposition">calculation</a>
     */
    public void getSwingTwist(final com.github.tagwanj.math.Vector3 axis, final Quaternion swing, final Quaternion twist) {
     ...
     * @return the angle in radians of the rotation around the specified axis
     */
    public float getAngleAroundRad(final com.github.tagwanj.math.Vector3 axis) {
