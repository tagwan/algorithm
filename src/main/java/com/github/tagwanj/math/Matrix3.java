...
public class Matrix3 implements Serializable {
    ...
    public Matrix3 setToRotation(com.github.tagwanj.math.Vector3 axis, float degrees) {
        return setToRotation(axis, MathUtil.cosDeg(degrees), MathUtil.sinDeg(degrees));
    }

    public Matrix3 setToRotation(com.github.tagwanj.math.Vector3 axis, float cos, float sin) {
        float[] val = this.val;
        float oc = 1.0f - cos;
     ...
     * @return This matrix for the purpose of chaining operations.
     */
    public Matrix3 setToTranslation(com.github.tagwanj.math.Vector2 translation) {
        float[] val = this.val;
     ...
     * @return This matrix for the purpose of chaining operations.
     */
    public Matrix3 setToScaling(com.github.tagwanj.math.Vector2 scale) {
        float[] val = this.val;
        val[M00] = scale.x;
        val[M10] = 0;
        val[M20] = 0;
     ...
     */
    public Matrix3 trn(com.github.tagwanj.math.Vector2 vector) {
        val[M02] += vector.x;
        val[M12] += vector.y;
        return this;
    }
     ...
     * @return This matrix for the purpose of chaining.
     */
    public Matrix3 trn(com.github.tagwanj.math.Vector3 vector) {
        val[M02] += vector.x;
        val[M12] += vector.y;
        return this;
    }
     ...
     * @return This matrix for the purpose of chaining.
     */
    public Matrix3 translate(com.github.tagwanj.math.Vector2 translation) {
        float[] val = this.val;
        tmp[M00] = 1;
        tmp[M10] = 0;
        tmp[M20] = 0;
     ...
     * @return This matrix for the purpose of chaining.
     */
    public Matrix3 scale(com.github.tagwanj.math.Vector2 scale) {
        float[] tmp = this.tmp;
        tmp[M00] = scale.x;
        tmp[M10] = 0;
        tmp[M20] = 0;
    ...
    public com.github.tagwanj.math.Vector2 getScale(com.github.tagwanj.math.Vector2 scale) {
        float[] val = this.val;
     ...
     *
     * @param scale
     *            The {@link com.github.tagwanj.math.Vector3} to use to scale this matrix.
     * @return This matrix for the purpose of chaining methods together.
     */
     ...
     *
     * @param scale
     *            The {@link com.github.tagwanj.math.Vector3} to use to scale this matrix. The z component
     *            will be ignored.
     * @return This matrix for the purpose of chaining methods together.
     */
