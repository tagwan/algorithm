...
public final class GeometryUtil {
	...
	(com.github.tagwanj.math.Vector3 nearest, com.github.tagwanj.math.Vector3 start, com.github.tagwanj.math.Vector3 end, com.github.tagwanj.math.Vector3 point) {
		nearest.set(start);
	...
	private static final com.github.tagwanj.math.Vector3 TMP_VEC_1 = new com.github.tagwanj.math.Vector3();
	private static final com.github.tagwanj.math.Vector3 TMP_VEC_2 = new com.github.tagwanj.math.Vector3();
	private static final com.github.tagwanj.math.Vector3 TMP_VEC_3 = new com.github.tagwanj.math.Vector3();
	 ...
	 */
	public static float getClosestPointOnTriangle(com.github.tagwanj.math.Vector3 a, com.github.tagwanj.math.Vector3 b, com.github.tagwanj.math.Vector3 c, com.github.tagwanj.math.Vector3 p, com.github.tagwanj.math.Vector3 out) {
		// Check if P in vertex region outside A
		com.github.tagwanj.math.Vector3 ab = TMP_VEC_1.set(b).sub(a);
		com.github.tagwanj.math.Vector3 ac = TMP_VEC_2.set(c).sub(a);
		com.github.tagwanj.math.Vector3 ap = TMP_VEC_3.set(p).sub(a);
		float d1 = ab.dot(ap);
		float d2 = ac.dot(ap);
		if (d1 <= 0.0f && d2 <= 0.0f)  {
			if (out != null)
		...
		com.github.tagwanj.math.Vector3 bp = TMP_VEC_3.set(p).sub(b);
		float d3 = ab.dot(bp);
		float d4 = ac.dot(bp);
		if (d3 >= 0.0f && d4 <= d3) {
			if (out != null)
		...
		if (vc <= 0.0f && d1 >= 0.0f && d3 <= 0.0f) {
			com.github.tagwanj.math.Vector3 ret = out != null ? out : TMP_VEC_3;
			float v = d1 / (d1 - d3);
		...
		com.github.tagwanj.math.Vector3 cp = TMP_VEC_3.set(p).sub(c);
		float d5 = ab.dot(cp);
		float d6 = ac.dot(cp);
		if (d6 >= 0.0f && d5 <= d6) {
			if (out != null)
