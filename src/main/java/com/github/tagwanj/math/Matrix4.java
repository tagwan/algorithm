 ...
 * major</a> 4 by 4 matrix. Like the {@link com.github.tagwanj.math.Vector3} class it allows the
...
public class Matrix4 implements Serializable {
     ...
     *            The scale
     */
    public Matrix4(com.github.tagwanj.math.Vector3 position, Quaternion rotation, com.github.tagwanj.math.Vector3 scale) {
     ...
     */
    public Matrix4 set(com.github.tagwanj.math.Vector3 position, Quaternion orientation) {
     ...
     * @return This matrix for chaining
     */
    public Matrix4 set(com.github.tagwanj.math.Vector3 position, Quaternion orientation, com.github.tagwanj.math.Vector3 scale) {
        return set(position.x, position.y, position.z, orientation.x, orientation.y, orientation.z, orientation.w,
     ...
     */
    public Matrix4 set(com.github.tagwanj.math.Vector3 xAxis, com.github.tagwanj.math.Vector3 yAxis, com.github.tagwanj.math.Vector3 zAxis, com.github.tagwanj.math.Vector3 pos) {
        val[M00] = xAxis.x;
        val[M01] = xAxis.y;
        val[M02] = xAxis.z;
        val[M10] = yAxis.x;
     ...
     * @return This matrix for the purpose of chaining methods together.
     */
    public Matrix4 trn(com.github.tagwanj.math.Vector3 vector) {
        val[M03] += vector.x;
        val[M13] += vector.y;
        val[M23] += vector.z;
        return this;
     ...
     * @return This matrix for the purpose of chaining methods together.
     */
    public Matrix4 setTranslation(com.github.tagwanj.math.Vector3 vector) {
        val[M03] = vector.x;
        val[M13] = vector.y;
        val[M23] = vector.z;
        return this;
     ...
     * @return This matrix for the purpose of chaining methods together.
     */
    public Matrix4 setToTranslation(com.github.tagwanj.math.Vector3 vector) {
        idt();
        val[M03] = vector.x;
        val[M13] = vector.y;
        val[M23] = vector.z;
     ...
     * @return This matrix for the purpose of chaining methods together.
     */
    public Matrix4 setToTranslationAndScaling(com.github.tagwanj.math.Vector3 translation, com.github.tagwanj.math.Vector3 scaling) {
        idt();
     ...
     * @return This matrix for the purpose of chaining methods together.
     */
    public Matrix4 setToRotation(com.github.tagwanj.math.Vector3 axis, float degrees) {
        if (degrees == 0) {
            idt();
            return this;
        }
     ...
     * @return This matrix for the purpose of chaining methods together.
     */
    public Matrix4 setToRotationRad(com.github.tagwanj.math.Vector3 axis, float radians) {
        if (radians == 0) {
            idt();
            return this;
        }
     ...
     * @return This matrix for the purpose of chaining methods together
     */
    public Matrix4 setToRotation(final com.github.tagwanj.math.Vector3 v1, final com.github.tagwanj.math.Vector3 v2) {
     ...
     * @return This matrix for chaining.
     */
    public Matrix4 setToScaling(com.github.tagwanj.math.Vector3 vector) {
        idt();
        val[M00] = vector.x;
        val[M11] = vector.y;
        val[M22] = vector.z;
    ...
    static final com.github.tagwanj.math.Vector3 l_vez = new com.github.tagwanj.math.Vector3();
    static final com.github.tagwanj.math.Vector3 l_vex = new com.github.tagwanj.math.Vector3();
    static final com.github.tagwanj.math.Vector3 l_vey = new com.github.tagwanj.math.Vector3();
     ...
     * @return This matrix for the purpose of chaining methods together.
     */
    public Matrix4 setToLookAt(com.github.tagwanj.math.Vector3 direction, com.github.tagwanj.math.Vector3 up) {
    ...
    static final com.github.tagwanj.math.Vector3 tmpVec = new com.github.tagwanj.math.Vector3();
     ...
     * @return This matrix
     */
    public Matrix4 setToLookAt(com.github.tagwanj.math.Vector3 position, com.github.tagwanj.math.Vector3 target, com.github.tagwanj.math.Vector3 up) {
    ...
    static final com.github.tagwanj.math.Vector3 right = new com.github.tagwanj.math.Vector3();
    static final com.github.tagwanj.math.Vector3 tmpForward = new com.github.tagwanj.math.Vector3();
    static final com.github.tagwanj.math.Vector3 tmpUp = new com.github.tagwanj.math.Vector3();

    public Matrix4 setToWorld(com.github.tagwanj.math.Vector3 position, com.github.tagwanj.math.Vector3 forward, com.github.tagwanj.math.Vector3 up) {
    ...
    public Matrix4 scl(com.github.tagwanj.math.Vector3 scale) {
        val[M00] *= scale.x;
        val[M11] *= scale.y;
        val[M22] *= scale.z;
        return this;
    ...
    public com.github.tagwanj.math.Vector3 getTranslation(com.github.tagwanj.math.Vector3 position) {
        position.x = val[M03];
        position.y = val[M13];
        position.z = val[M23];
        return position;
     ...
     */
    public com.github.tagwanj.math.Vector3 getScale(com.github.tagwanj.math.Vector3 scale) {
     ...
     * stored in the vector array. This is the same as {@link com.github.tagwanj.math.Vector3#mul(Matrix4)}.
     *
     * @param mat
     *            the matrix
     * @param vec
     ...
     * vectors and must be >= 3. This is the same as {@link com.github.tagwanj.math.Vector3#mul(Matrix4)}
     ...
     * {@link com.github.tagwanj.math.Vector3#prj(Matrix4)}.
     *
     * @param mat
     *            the matrix
     * @param vec
     ...
     * same as {@link com.github.tagwanj.math.Vector3#prj(Matrix4)} applied to multiple vectors.
     *
     * @param mat
     *            the matrix
     * @param vecs
     ...
     * vector, with x being the first element, y being the second and z being the
     * last component. The result is stored in the vector array. This is the same as
     * {@link com.github.tagwanj.math.Vector3#rot(Matrix4)}.
     *
     * @param mat
     *            the matrix
     * @param vec
     ...
     * vectors stored in the vectors array. The stride parameter specifies the
     * number of floats between subsequent vectors and must be >= 3. This is the
     * same as {@link com.github.tagwanj.math.Vector3#rot(Matrix4)} applied to multiple vectors.
     *
     * @param mat
     *            the matrix
     * @param vecs
     ...
     * @return This matrix for the purpose of chaining methods together.
     */
    public Matrix4 translate(com.github.tagwanj.math.Vector3 translation) {
     ...
     * @return This matrix for the purpose of chaining methods together.
     */
    public Matrix4 rotate(com.github.tagwanj.math.Vector3 axis, float degrees) {
        if (degrees == 0)
            return this;
     ...
     * @return This matrix for the purpose of chaining methods together.
     */
    public Matrix4 rotateRad(com.github.tagwanj.math.Vector3 axis, float radians) {
        if (radians == 0)
            return this;
     ...
     * @return This matrix for the purpose of chaining methods together
     */
    public Matrix4 rotate(final com.github.tagwanj.math.Vector3 v1, final Vector3 v2) {
