...
public final class Intersector {
    private final static com.github.tagwanj.math.Vector3 v0 = new com.github.tagwanj.math.Vector3();
    private final static com.github.tagwanj.math.Vector3 v1 = new com.github.tagwanj.math.Vector3();
    private final static com.github.tagwanj.math.Vector3 v2 = new com.github.tagwanj.math.Vector3();
     ...
     */
    public static boolean isPointInTriangle(com.github.tagwanj.math.Vector3 point, com.github.tagwanj.math.Vector3 t1, com.github.tagwanj.math.Vector3 t2, com.github.tagwanj.math.Vector3 t3) {
        v0.set(t1).sub(point);
        v1.set(t2).sub(point);
        v2.set(t3).sub(point);
    ...
    public static boolean isPointInTriangle(com.github.tagwanj.math.Vector2 p, com.github.tagwanj.math.Vector2 a, com.github.tagwanj.math.Vector2 b, com.github.tagwanj.math.Vector2 c) {
        float px1 = p.x - a.x;
        float py1 = p.y - a.y;
    ...
    public static boolean intersectSegmentPlane(com.github.tagwanj.math.Vector3 start, com.github.tagwanj.math.Vector3 end, Plane plane, com.github.tagwanj.math.Vector3 intersection) {
        com.github.tagwanj.math.Vector3 dir = v0.set(end).sub(start);
     ...
     */
    public static int pointLineSide(com.github.tagwanj.math.Vector2 linePoint1, com.github.tagwanj.math.Vector2 linePoint2, com.github.tagwanj.math.Vector2 point) {
     ...
     */
    public static boolean isPointInPolygon(List<com.github.tagwanj.math.Vector2> polygon, com.github.tagwanj.math.Vector2 point) {
        com.github.tagwanj.math.Vector2 lastVertice = polygon.get(polygon.size() - 1);
        boolean oddNodes = false;
        for (int i = 0; i < polygon.size(); i++) {
            com.github.tagwanj.math.Vector2 vertice = polygon.get(i);
     ...
     * @return true if the point is in the polygon
     */
    public static boolean isPointInPolygon(List<com.github.tagwanj.math.Vector3> polygon, com.github.tagwanj.math.Vector3 point) {
        com.github.tagwanj.math.Vector3 lastVertice = polygon.get(polygon.size() - 1);
        boolean oddNodes = false;
        for (int i = 0; i < polygon.size(); i++) {
            com.github.tagwanj.math.Vector3 vertice = polygon.get(i);
    ...
    /** Returns the distance between the given segment and point. */
    public static float distanceSegmentPoint(com.github.tagwanj.math.Vector2 start, com.github.tagwanj.math.Vector2 end, com.github.tagwanj.math.Vector2 point) {
        return nearestSegmentPoint(start, end, point, v2tmp).dst(point);
    }

    /** Returns a point on the segment nearest to the specified point. */
    public static com.github.tagwanj.math.Vector2 nearestSegmentPoint(com.github.tagwanj.math.Vector2 start, com.github.tagwanj.math.Vector2 end, com.github.tagwanj.math.Vector2 point, com.github.tagwanj.math.Vector2 nearest) {
    ...
    /** Returns a point on the segment nearest to the specified point. */
    public static com.github.tagwanj.math.Vector2 nearestSegmentPoint(float startX, float startY, float endX, float endY, float pointX,
                                                                      float pointY, com.github.tagwanj.math.Vector2 nearest) {
     ...
     */
    public static boolean intersectSegmentCircle(com.github.tagwanj.math.Vector2 start, com.github.tagwanj.math.Vector2 end, com.github.tagwanj.math.Vector2 center, float squareRadius) {
     ...
     *         present
     */
    public static float intersectSegmentCircleDisplace(com.github.tagwanj.math.Vector2 start, com.github.tagwanj.math.Vector2 end, com.github.tagwanj.math.Vector2 point, float radius,
                                                       com.github.tagwanj.math.Vector2 displacement) {
     ...
     */
    public static float intersectRayRay(com.github.tagwanj.math.Vector2 start1, com.github.tagwanj.math.Vector2 direction1, com.github.tagwanj.math.Vector2 start2, com.github.tagwanj.math.Vector2 direction2) {
     ...
     */
    public static boolean intersectRayPlane(Ray ray, Plane plane, com.github.tagwanj.math.Vector3 intersection) {
    ...
    public static float intersectLinePlane(float x, float y, float z, float x2, float y2, float z2, Plane plane,
                                           com.github.tagwanj.math.Vector3 intersection) {
        com.github.tagwanj.math.Vector3 direction = tmp.set(x2, y2, z2).sub(x, y, z);
        com.github.tagwanj.math.Vector3 origin = tmp2.set(x, y, z);
    ...
    private static final Plane p = new Plane(new com.github.tagwanj.math.Vector3(), 0);
    private static final com.github.tagwanj.math.Vector3 i = new com.github.tagwanj.math.Vector3();
     ...
     */
    public static boolean intersectRayTriangle(Ray ray, com.github.tagwanj.math.Vector3 t1, com.github.tagwanj.math.Vector3 t2, com.github.tagwanj.math.Vector3 t3, com.github.tagwanj.math.Vector3 intersection) {
        com.github.tagwanj.math.Vector3 edge1 = v0.set(t2).sub(t1);
        com.github.tagwanj.math.Vector3 edge2 = v1.set(t3).sub(t1);

        com.github.tagwanj.math.Vector3 pvec = v2.set(ray.direction).cross(edge2);
        ...
        com.github.tagwanj.math.Vector3 tvec = i.set(ray.origin).sub(t1);
        float u = tvec.dot(pvec) * det;
        if (u < 0.0f || u > 1.0f)
            return false;

        com.github.tagwanj.math.Vector3 qvec = tvec.cross(edge1);
     ...
     * @return Whether an intersection is present.
     */
    public static boolean intersectRaySphere(Ray ray, com.github.tagwanj.math.Vector3 center, float radius, com.github.tagwanj.math.Vector3 intersection) {
     ...
     * @return Whether the ray and the bounding box intersect.
     */
    static public boolean intersectRayBoundsFast(Ray ray, com.github.tagwanj.math.Vector3 center, com.github.tagwanj.math.Vector3 dimensions) {
    ...
    static com.github.tagwanj.math.Vector3 best = new com.github.tagwanj.math.Vector3();
    static com.github.tagwanj.math.Vector3 tmp = new com.github.tagwanj.math.Vector3();
    static com.github.tagwanj.math.Vector3 tmp1 = new com.github.tagwanj.math.Vector3();
    static com.github.tagwanj.math.Vector3 tmp2 = new com.github.tagwanj.math.Vector3();
    static com.github.tagwanj.math.Vector3 tmp3 = new com.github.tagwanj.math.Vector3();
    static com.github.tagwanj.math.Vector2 v2tmp = new com.github.tagwanj.math.Vector2();
     ...
     */
    public static boolean intersectRayTriangles(Ray ray, float[] triangles, com.github.tagwanj.math.Vector3 intersection) {
     ...
     * @return Whether the ray and the triangles intersect.
     */
    public static boolean intersectRayTriangles(Ray ray, List<com.github.tagwanj.math.Vector3> triangles, com.github.tagwanj.math.Vector3 intersection) {
        float min_dist = Float.MAX_VALUE;
        boolean hit = false;
     ...
     */
    public static boolean intersectLines(com.github.tagwanj.math.Vector2 p1, com.github.tagwanj.math.Vector2 p2, com.github.tagwanj.math.Vector2 p3, com.github.tagwanj.math.Vector2 p4, com.github.tagwanj.math.Vector2 intersection) {
    ...
    public static boolean intersectLines(float x1, float y1, float x2, float y2, float x3, float y3, float x4, float y4,
                                         com.github.tagwanj.math.Vector2 intersection) {
        float d = (y4 - y3) * (x2 - x1) - (x4 - x3) * (y2 - y1);
        if (d == 0)
            return false;
     ...
     */
    public static boolean intersectSegments(com.github.tagwanj.math.Vector2 p1, com.github.tagwanj.math.Vector2 p2, com.github.tagwanj.math.Vector2 p3, com.github.tagwanj.math.Vector2 p4, com.github.tagwanj.math.Vector2 intersection) {
        float x1 = p1.x, y1 = p1.y, x2 = p2.x, y2 = p2.y, x3 = p3.x, y3 = p3.y, x4 = p4.x, y4 = p4.y;
    ...
    public static boolean intersectSegments(float x1, float y1, float x2, float y2, float x3, float y3, float x4,
                                            float y4, com.github.tagwanj.math.Vector2 intersection) {
        float d = (y4 - y3) * (x2 - x1) - (x4 - x3) * (y2 - y1);
        if (d == 0)
            return false;
    ...
    static com.github.tagwanj.math.Vector3 intersection = new Vector3();
    ...
    public static class MinimumTranslationVector {
        ...
        public com.github.tagwanj.math.Vector2 normal = new Vector2();
