...
import com.github.tagwanj.ai.nav.triangle.Triangle;
import com.github.tagwanj.ai.pfa.Connection;
import com.github.tagwanj.ai.pfa.IndexedGraph;
import com.github.tagwanj.ai.quadtree.QuadTree;
...
public class PolygonGraph implements IndexedGraph<Polygon> {
    ...
    private void initCalculate(PolygonData polygonData, int scale) {
        quadTree = new PolygonQuadTree(polygonData.getStartX() * scale, polygonData.getStartZ() * scale, polygonData.getEndX() * scale,
