...
import com.github.tagwanj.ai.btree.BranchTask;
import com.github.tagwanj.ai.btree.Task;
import com.github.tagwanj.ai.btree.annotation.TaskAttribute;
			...
			public Boolean onChildSuccess(Parallel<?> parallel) {
				...
				case Join:
					return parallel.noRunningTasks
							&& parallel.children.get(parallel.children.size() - 1).getStatus() == Task.Status.SUCCEEDED
									? Boolean.TRUE
									: null;
				case Resume:
				default:
