...
public class Node<T> {
	...
	public Node(float x, float z, float w, float h, Node<T> parent, int depth) {
		...
		this.parent = parent;
		this.depth = depth;
		this.polygon = new Polygon(0, new com.github.tagwanj.math.Vector3(x, z), new com.github.tagwanj.math.Vector3(x, z + h), new com.github.tagwanj.math.Vector3(x + w, z + h),
				new Vector3(x + w, z));
	}
